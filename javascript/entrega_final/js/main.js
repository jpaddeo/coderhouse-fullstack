...
class Carrito {
  ...
  renderizarCarrito() {
    ...
    const $vaciarCarritoButton = document.querySelector('#clearCart');

    // Limpiar lista actual
    $listaCarrito.innerHTML = '';

    // Remover botón de finalizar compra si existe
    const $existingCheckoutButton =
      $cartContent.querySelector('.checkout-button');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  $productForm.addEventListener('submit', (e) => {
    ...
    const nuevoProducto = new Producto($nombre, $precio, categoriaSeleccionada);
